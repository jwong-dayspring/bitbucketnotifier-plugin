...
public class BitbucketNotifierTest
{
	final static String sha1 = "1234567890123456789012345678901234567890";
	public BitbucketNotifier buildBitbucketNotifier() {
		return new BitbucketNotifier(
			"http://localhost",
			"scot",
			true,
			null,
